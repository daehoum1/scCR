...
def parse_args():
    ...
    parser.add_argument('--name', type=str, default='baron_human')
    ...
    parser.add_argument('--sym', type=str2bool, default=True)
    ...
    # MNAR
    parser.add_argument('--mnar', type=int, default=False)
